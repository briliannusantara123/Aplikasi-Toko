...
<div class="panel">
                <div class="panel-heading">
                  <h3 class="panel-title">Update Data Distributor</h3>
                </div>
   ...
   <div class="form-group">
    ...
    <input name="kode_distributor"type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
